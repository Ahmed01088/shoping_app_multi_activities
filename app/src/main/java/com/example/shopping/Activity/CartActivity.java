...
public class CartActivity extends AppCompatActivity {
    ...
    private void bottomNavigation() {
        ...
        ConstraintLayout logOutCat=findViewById(R.id.logOutCart);
    ...
    private void calculateCard() {
        ...
        totalFeeTxt.setText("EG" + itemTotal);
        taxTxt.setText("EG" + tax);
        deliveryTxt.setText("EG" + delivery);
        totalTxt.setText("EG" + total);
    }
